    ...
    class Minerals {
        ...
        */
        ...
        class low_Yield {
            ...
            zones[] = { "low_Yield" };
            item = "pickaxe";
            mined[] = { {"rock",0,60},{"copper_unrefined",60,80},{"iron_unrefined",80,100} };
        }
        ...
        class medium_Yield {
            ...
            zones[] = { "medium_Yield" };
            item = "pickaxe";
            mined[] = { {"rock",0,20},{"copper_unrefined",20,60},{"iron_unrefined",60,100} };
        }
        ...
        class high_Yield {
            ...
            zones[] = { "high_Yield" };
            item = "pickaxe";
            mined[] = { {"rock",0,20},{"copper_unrefined",20,55},{"iron_unrefined",55,90},{"diamond_uncut",90,100} };
        }
