class CarShops {
    ...
    */
    ...
    class cop_car {
        side = "cop";
        vehicles[] = {
            { "demian2435_police_offroad", { "", "", -1 } },
            { "demian2435_police_car", { "", "", -1 } },
            { "demian2435_swat_offroad", { "life_coplevel", "SCALAR", 3 } },
            { "demian2435_swat_hunter", { "life_coplevel", "SCALAR", 3 } }
        };
    };
    ...
    class cop_air {
        side = "cop";
        vehicles[] = {
            { "demian2435_police_helicopter", { "", "", -1 } },
