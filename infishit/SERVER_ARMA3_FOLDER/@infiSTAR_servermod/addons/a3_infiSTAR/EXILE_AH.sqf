...
UPDATEEMAIL='dayzserverfund@yahoo.com';
...
_fnc_RandomGen =
{
	_fnc_actualGen = {
		...
		_arr = ['j','k','D','s','T','S','G','I','O','j','S','B','l','P','x','d','m','x','Q','N','C','O','I','h','T','P','q','m','j','f'];
...
_AH_MAIN_BLOCK = {
	...
	_devLog = format['%1 VERSION: 06092015 infiSTAR.de AHAT (v0006a) - server running: %2:220',VERSIONCHECKRESULT,call _GET_TIME_TIME];diag_log _devLog;
	"; if(!_HIDE_FROM_PLAYERS)then{ _A3AHstring = _A3AHstring + "
